    ...
    <div className="space-y-20">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-12">
            <AnimateOnScroll animation="animate-slide-in-left" delay={100}>
              <div>
                <h1 className="text-4xl lg:text-5xl font-bold mb-6 text-primary-800 leading-tight">
                ...
                <p className="text-lg text-warmGray-700 mb-6 leading-relaxed">
                  Паломницький центр - це місце, де духовність поєднується з подорожами.
                ...
                <p className="text-lg text-warmGray-700 leading-relaxed">
                  ...
                  досвід паломництва. За 13 років діяльності ми організували понад
      ...
      <section className="bg-primary-50 py-16">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <AnimateOnScroll animation="animate-fade-in" delay={100}>
            <h2 className="text-3xl font-bold mb-2 text-primary-800">Наша місія та цінності</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
            <AnimateOnScroll animation="animate-slide-in-up" delay={100}>
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <h3 className="text-xl font-semibold mb-3 text-primary-800">Духовне збагачення</h3>
            ...
            <AnimateOnScroll animation="animate-slide-in-up" delay={200}>
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <h3 className="text-xl font-semibold mb-3 text-primary-800">Спільнота</h3>
                <p className="text-warmGray-600">
            ...
            <AnimateOnScroll animation="animate-slide-in-up" delay={300}>
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <h3 className="text-xl font-semibold mb-3 text-primary-800">Безпека і комфорт</h3>
                <p className="text-warmGray-600">
      ...
      <section className="max-w-5xl mx-auto px-4">
        <AnimateOnScroll animation="animate-fade-in" delay={100}>
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-2 text-primary-800">Історія нашого центру</h2>
            <div className="w-20 h-1 bg-primary-500 mx-auto mb-8 rounded-full"></div>
          </div>
        </AnimateOnScroll>
      ...
      <section className="bg-warmGray-100 py-16">
        <div className="max-w-6xl mx-auto px-4">
          <AnimateOnScroll animation="animate-fade-in" delay={100}>
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-2 text-primary-800">Наша команда</h2>
              <div className="w-20 h-1 bg-primary-500 mx-auto mb-8 rounded-full"></div>
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-warmGray-600">
                    Маємо 13-річний досвід організації паломницьких поїздок до різноманітних святих місць по всьому світу.
                  </p>
                </div>
              </div>
